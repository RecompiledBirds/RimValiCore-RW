...
namespace RimValiCore_RW.Windows
{
    ...
    {
        private readonly List<FloatMenuOption> floatMenuOptions = new List<FloatMenuOption>();
        private readonly List<RenderableDef> renderableDefs;
        private readonly List<string> labels = new List<string>(4) { "North", "East", "South", "West" };

        private readonly Rect rectFull = new Rect(0f, 0f, 460f, 270f);
        private readonly Rect buttonDefSelect = new Rect(20f, 20f, 90f, 30f);
        private readonly Rect buttonPosSize = new Rect(130f, 20f, 90f, 30f);

        private readonly Rect label = new Rect(20f, 70f, 90f, 30f);
        private readonly Rect inputX = new Rect(20f, 120f, 90f, 30f);
        private readonly Rect inputY = new Rect(20f, 170f, 90f, 30f);
        private readonly Rect inputZ = new Rect(20f, 220f, 90f, 30f);
